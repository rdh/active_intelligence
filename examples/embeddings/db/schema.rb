...
ActiveRecord::Schema[7.1].define(version: 20_240_605_003_354) do
  ...
  create_table 'active_intelligence_embeddings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[embeddable_type embeddable_id], name: 'index_active_intelligence_embeddings_on_embeddable'
    t.index ['embedding'], name: 'index_active_intelligence_embeddings_on_embedding', opclass: :vector_cosine_ops,
                           using: :hnsw
  end
